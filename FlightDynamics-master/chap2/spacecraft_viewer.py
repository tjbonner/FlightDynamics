...
class spacecraft_viewer():
    ...
    def _get_spacecraft_points(self):
        ...
        points = np.array([[4, 0, 0.5],  # point 1
                           [2, 1, -2],  # point 2
                           [2, -1, -2],  # point 3
                           [2, -1, 2],  # point 4
                           [2, 1, 2],  # point 5
        ...
        meshColors[0] = blue  # nose
        meshColors[1] = blue  # nose
        meshColors[2] = blue  # nose
        meshColors[3] = blue  # nose
    ...
    def _points_to_mesh(self, points):
        ...
        mesh = np.array([[points[0], points[1], points[2]],  # nose
                         ...
                         [points[1], points[2], points[5]],  # body
                         [points[2], points[3], points[5]],  # body
                         [points[3], points[4], points[5]],  # body
                         [points[1], points[4], points[5]],  # body
                         [points[6], points[7], points[8]],  # wing
                         [points[6], points[8], points[9]],  # wing
                         [points[10], points[11], points[12]],  # tail
                         [points[10], points[12], points[13]],  # tail
